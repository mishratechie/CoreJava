 ...
 * or first Increases and then Decreases. Some examples of a Special Triplet are:
 (1,2,1)(1,2,1)
 (4,2,4)(4,2,4)
 22 triplets differ from each other if one or more indices from the array AA appear in one of them and doesn't in the other. Triplets duplicate in value may exist. Vanya just loved solving this puzzle and wants you to do it too. Can you ? As the answer may be large, print it Modulo 109+7109+7.
...
public class Triplet {
    ...
    public static int findTriplet(int [] arr) { int numberOfTriplets=0;
    ...
    private static int findNo(int[] arr, int i, int j) { int number=0;
