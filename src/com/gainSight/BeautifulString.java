...
* Not only this, but 'a' should be the first character of this beautiful string.
...
public class BeautifulString {
    ...
    public static int requiredOperations(String s, int index, Character previous) {
        ...
        if(index==s.length()) return 0;//This statment will help you terminate this recursive block as soon as lenght of the string is iterated
